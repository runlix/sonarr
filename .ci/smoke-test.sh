...
# Smoke test for Sonarr Docker image
# This script receives IMAGE_TAG from the workflow environment

IMAGE="${IMAGE_TAG}"
PLATFORM="${PLATFORM:-linux/amd64}"
CONTAINER_NAME="sonarr-smoke-test-${RANDOM}"
SONARR_PORT="8989"
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}🧪 Sonarr Smoke Test${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo "Image: ${IMAGE}"
...
cleanup() {
  ...
  if docker ps -a | grep -q "${CONTAINER_NAME}"; then
    ...
    docker logs "${CONTAINER_NAME}" > /tmp/sonarr-smoke-test.log 2>&1 || true
    echo "Logs saved to: /tmp/sonarr-smoke-test.log"
  fi
...
echo -e "${BLUE}⏳ Waiting for Sonarr to initialize...${NC}"
...
if grep -qi "starting sonarr" <<< "$LOGS" 2>/dev/null; then
  echo -e "${GREEN}✅ Sonarr startup message found${NC}"
else
...
HEALTH_URL="http://localhost:${SONARR_PORT}/health"
MAX_ATTEMPTS=24
ATTEMPT=0
HEALTH_OK=false
...
PING_URL="http://localhost:${SONARR_PORT}/ping"
...
ROOT_URL="http://localhost:${SONARR_PORT}/"
